...
static const char* ServerInterface_method_names[] = {
  ...
  "/greyvarproto.ServerInterface/Move",
};
...
ServerInterface::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_Move_(ServerInterface_method_names[2], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status ServerInterface::Stub::Move(::grpc::ClientContext* context, const ::greyvarproto::MoveRequest& request, ::greyvarproto::MoveResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_Move_, context, request, response);
}

void ServerInterface::Stub::experimental_async::Move(::grpc::ClientContext* context, const ::greyvarproto::MoveRequest* request, ::greyvarproto::MoveResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Move_, context, request, response, std::move(f));
}

::grpc::ClientAsyncResponseReader< ::greyvarproto::MoveResponse>* ServerInterface::Stub::AsyncMoveRaw(::grpc::ClientContext* context, const ::greyvarproto::MoveRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::greyvarproto::MoveResponse>::Create(channel_.get(), cq, rpcmethod_Move_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::greyvarproto::MoveResponse>* ServerInterface::Stub::PrepareAsyncMoveRaw(::grpc::ClientContext* context, const ::greyvarproto::MoveRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::greyvarproto::MoveResponse>::Create(channel_.get(), cq, rpcmethod_Move_, context, request, false);
}
...
ServerInterface::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ServerInterface::Service, ::greyvarproto::MoveRequest, ::greyvarproto::MoveResponse>(
          std::mem_fn(&ServerInterface::Service::Move), this)));
}
...
::grpc::Status ServerInterface::Service::Move(::grpc::ServerContext* context, const ::greyvarproto::MoveRequest* request, ::greyvarproto::MoveResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
